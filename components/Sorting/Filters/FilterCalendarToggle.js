          ...
          >
            {showComparison ? (
              <>
                ...
                <div className="relative overflow-hidden transition-all duration-300 w-0 lg:group-hover:w-32 group-hover:w-16">
              ...
              <>
                ...
                <div className="relative overflow-hidden transition-all duration-300 w-0 lg:group-hover:w-24 group-hover:w-16">
                  <span className="ml-1 whitespace-nowrap text-sm font-futura-bold">
                    Compare
                  </span>
                </div>
